...
# List of PDF paths
pdf_paths = ["C:/Users/Lenovo/ML Notebooks/ssL/langchain practice/pdfs/Delivery policy ssl_new.pdf", 
             "C:/Users/Lenovo/ML Notebooks/ssL/langchain practice/pdfs/Employee Policy ssl_new.pdf", 
             "C:/Users/Lenovo/ML Notebooks/ssL/langchain practice/pdfs/Order policy ssl_new.pdf",
             "C:/Users/Lenovo/ML Notebooks/ssL/langchain practice/pdfs/Return Policy ssl_new.pdf"]
...
def get_response_from_query(context, query, k=4):
    """
    ...
    response = chain.run(question=query, docs=context)
